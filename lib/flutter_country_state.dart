                    ...
                    return filter == ""
                        ? Container(
                            ...
                            color: selectedIndex.contains(index)
                                ? widget.selectedCountryBackgroundColor
                                : widget.notSelectedCountryBackgroundColor,
                            child: ListTile(
    ...
    return Container(
      child: Column(
        children: <Widget>[
          Padding(
            padding: const EdgeInsets.all(18.0),
            child: Text("states in ${Variables.country}".toUpperCase(),
                style: widget.stateHeaderStyle),
          ),
          Divider(),
          Expanded(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Container(
                    ...
                    color: selectedState.contains(index)
                        ? widget.selectedStateBackgroundColor
                        : widget.notSelectedStateBackgroundColor,
                    child: ListTile(
                        leading: CircleAvatar(
